  ...
  const steps: DriveStep[] = [
    ...
    },
    {
      ...
      popover: {
        ...
        description:
          axisType === '1d'
            ? '横帯がそのカードの意見の範囲 (最小〜最大)、色の濃い部分に意見が集中しています。太い縦線は中央値、ドットは一人ひとりの配置です。印付きのドットにカーソルを合わせると、その人が書いたメモが読めます。'
            : '楕円が意見の散らばり、点が全体の中心 (重心) です。「まとめて / 1枚ずつ / 一覧」で表示を切り替えられます。「1枚ずつ」では印付きのドットにカーソルを合わせるとメモが読めます。',
      },
    },
    {
